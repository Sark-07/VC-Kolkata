...
const TeacherLogin = () => {
  ...
  return (
    ...
    // </div>
    <Login setCaptcha={setCaptcha} setEmail={setEmail} setPassword={setPassword} setShowPassword={setShowPassword} showPassword={showPassword} LoadCanvasTemplate={LoadCanvasTemplate} validEmail={validEmail} password={password} handleSubmit={handleSubmit} baseUrl={baseUrl}/>
  );
};
